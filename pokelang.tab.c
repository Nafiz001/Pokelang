...
{
       0,   555,   555,   557,   561,   562,   566,   567,   568,   572,
     573,   574,   575,   576,   577,   583,   589,   582,   598,   597,
     608,   613,   607,   622,   621,   633,   634,   638,   644,   650,
     659,   660,   661,   662,   663,   664,   665,   670,   674,   675,
     679,   684,   690,   695,   703,   705,   709,   710,   711,   712,
     713,   714,   718,   722,   723,   728,   735,   742,   749,   756,
     760,   761,   765,   766,   771,   778,   785,   786,   793,   794,
     805,   806,   807,   818,   838,   839,   843,   844,   858,   859,
     868,   869,   878,   879,   883,   890,   891,   895,   899,   903,
     910,   911,   915,   922,   923,   927,   931,   938,   939,   944,
     952,   953,   972,   981,   993,  1007,  1008,  1013,  1014,  1018,
    1019,  1020,  1024,  1025,  1029,  1034,  1043,  1049,  1055,  1060,
    1065,  1070,  1075,  1080,  1085,  1090,  1095,  1100,  1119,  1118,
    1127
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* program: declaration_list  */
#line 557 ".\\pokelang.y"
                       { trace_reduce("program -> declaration_list"); }
#line 1881 "pokelang.tab.c"
    break;

  case 6: /* declaration: preprocessor_directive  */
#line 566 ".\\pokelang.y"
                           { trace_reduce("declaration -> preprocessor_directive"); }
#line 1887 "pokelang.tab.c"
    break;

  case 7: /* declaration: function_declaration  */
#line 567 ".\\pokelang.y"
                           { trace_reduce("declaration -> function_declaration"); }
#line 1893 "pokelang.tab.c"
    break;

  case 8: /* declaration: variable_declaration SEMICOLON  */
#line 568 ".\\pokelang.y"
                                     { trace_reduce("declaration -> variable_declaration SEMICOLON"); }
#line 1899 "pokelang.tab.c"
    break;
...
#line 709 ".\\pokelang.y"
                       { trace_reduce("statement -> compound_statement"); }
#line 2120 "pokelang.tab.c"
    break;

  case 47: /* statement: expression_statement  */
#line 710 ".\\pokelang.y"
                           { trace_reduce("statement -> expression_statement"); }
#line 2126 "pokelang.tab.c"
    break;

  case 48: /* statement: selection_statement  */
#line 711 ".\\pokelang.y"
                          { trace_reduce("statement -> selection_statement"); }
#line 2132 "pokelang.tab.c"
    break;

  case 49: /* statement: iteration_statement  */
#line 712 ".\\pokelang.y"
                          { trace_reduce("statement -> iteration_statement"); }
#line 2138 "pokelang.tab.c"
    break;

  case 50: /* statement: jump_statement  */
#line 713 ".\\pokelang.y"
                     { trace_reduce("statement -> jump_statement"); }
#line 2144 "pokelang.tab.c"
    break;

  case 51: /* statement: variable_declaration SEMICOLON  */
#line 714 ".\\pokelang.y"
                                     { trace_reduce("statement -> variable_declaration SEMICOLON"); }
#line 2150 "pokelang.tab.c"
    break;
...
#line 2194 "pokelang.tab.c"
    break;

  case 59: /* selection_statement: SWITCH LPAREN expression RPAREN LBRACE case_list RBRACE  */
#line 756 ".\\pokelang.y"
                                                              { trace_reduce("selection_statement -> SWITCH (...) { case_list }"); }
#line 2200 "pokelang.tab.c"
    break;
...
#line 2222 "pokelang.tab.c"
    break;

  case 66: /* iteration_statement: FOR LPAREN expression_statement expression_statement RPAREN statement  */
#line 785 ".\\pokelang.y"
                                                                            { trace_reduce("iteration_statement -> FOR (init;cond;) statement"); }
#line 2228 "pokelang.tab.c"
    break;
...
#line 2239 "pokelang.tab.c"
    break;

  case 68: /* iteration_statement: FOR LPAREN variable_declaration SEMICOLON expression_statement RPAREN statement  */
#line 793 ".\\pokelang.y"
                                                                                      { trace_reduce("iteration_statement -> FOR (decl;cond;) statement"); }
#line 2245 "pokelang.tab.c"
    break;
...
#line 2256 "pokelang.tab.c"
    break;

  case 70: /* jump_statement: BREAK SEMICOLON  */
#line 805 ".\\pokelang.y"
                    { trace_reduce("jump_statement -> BREAK ;"); }
#line 2262 "pokelang.tab.c"
    break;

  case 71: /* jump_statement: CONTINUE SEMICOLON  */
#line 806 ".\\pokelang.y"
                         { trace_reduce("jump_statement -> CONTINUE ;"); }
#line 2268 "pokelang.tab.c"
    break;
...
#line 839 ".\\pokelang.y"
                                             { (yyval.expr) = (yyvsp[0].expr); }
#line 2315 "pokelang.tab.c"
    break;

  case 76: /* assignment_expression: logical_or_expression  */
#line 843 ".\\pokelang.y"
                          { (yyval.expr) = (yyvsp[0].expr); trace_reduce("assignment_expression -> logical_or_expression"); }
#line 2321 "pokelang.tab.c"
    break;
...
#line 2480 "pokelang.tab.c"
    break;

  case 97: /* unary_expression: postfix_expression  */
#line 938 ".\\pokelang.y"
                       { (yyval.expr) = (yyvsp[0].expr); }
#line 2486 "pokelang.tab.c"
    break;
...
#line 2504 "pokelang.tab.c"
    break;

  case 100: /* postfix_expression: primary_expression  */
#line 952 ".\\pokelang.y"
                       { (yyval.expr) = (yyvsp[0].expr); }
#line 2510 "pokelang.tab.c"
    break;
